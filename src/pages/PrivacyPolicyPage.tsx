      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        ...
        <FadeIn immediate>
          <section className="mb-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Order Data</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Cookies & Analytics</h3>
        ...
        <FadeIn immediate>
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg p-6 bg-warm">
                <h3 className="font-semibold text-gray-900 mb-2">USPS (Shipping)</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
